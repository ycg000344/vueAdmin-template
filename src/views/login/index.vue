<template>
  <div class="login-container">
    ...
    <el-form class="login-form" autoComplete="on" :model="loginForm" :rules="loginRules" ref="loginForm" label-position="left">
      ...
      <el-button type="primary" style="width:85%;margin-bottom:30px;" :loading="loading" @click.native.prevent="handleLogin">{{$t('login.logIn')}}</el-button>
      <!-- <el-button type="primary" @click="showDialog=true">h5</el-button> -->
      <el-popover 
        placement="right"
        trigger="hover">
  ...
  methods: {
    showPwd() {
      if (this.passwordType === 'password') {
        ...
        this.loginForm.password = 'qqq123'
